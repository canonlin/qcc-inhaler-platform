        ...
        <div style={{ background: "#fff", borderRadius: 20, padding: "24px 20px", boxShadow: "0 4px 24px rgba(0,0,0,0.06)" }}>
          ...
          {step < 3 && (
            <div style={{ marginTop: 24, display: "flex", gap: 10 }}>
              ...
              <button onClick={() => step === 2 ? handleSubmit() : setStep(p => p + 1)} disabled={!canNext()}
    ...
    <div style={{ minHeight: "100vh", background: "#f0fdf4", fontFamily: "'Noto Sans TC', sans-serif" }}>
      <div style={{ maxWidth: 560, margin: "0 auto", padding: "16px" }}>
        ...
        <button onClick={handleSubmit} disabled={!canSubmit} style={{
          ...
          background: canSubmit ? "#16a34a" : "#d1fae5", color: canSubmit ? "#fff" : "#86efac",
          fontWeight: 900, fontSize: 16, cursor: canSubmit ? "pointer" : "not-allowed", marginBottom: 24,
        }}>送出問卷 ✓</button>
      </div>
    </div>
  );
